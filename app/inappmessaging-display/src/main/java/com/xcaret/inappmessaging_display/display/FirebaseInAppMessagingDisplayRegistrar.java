...
import com.xcaret.inappmessaging_display.BuildConfig;
import com.xcaret.inappmessaging_display.display.internal.injection.components.AppComponent;
import com.xcaret.inappmessaging_display.display.internal.injection.components.DaggerAppComponent;
import com.xcaret.inappmessaging_display.display.internal.injection.components.DaggerUniversalComponent;
import com.xcaret.inappmessaging_display.display.internal.injection.components.UniversalComponent;
import com.xcaret.inappmessaging_display.display.internal.injection.modules.ApplicationModule;
import com.xcaret.inappmessaging_display.display.internal.injection.modules.HeadlessInAppMessagingModule;
  ...
  public List<Component<?>> getComponents() {
    return Arrays.asList(
        Component.builder(FirebaseInAppMessagingDisplay.class)
            ...
            .eagerInDefaultApp()
            .build(),
        LibraryVersionComponent.create("fire-fiamd", BuildConfig.LIBRARY_PACKAGE_NAME));
  }
