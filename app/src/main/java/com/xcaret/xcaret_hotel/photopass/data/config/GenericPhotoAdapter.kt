...
class GenericPhotoAdapter<T : ListItemViewModel>(@LayoutRes val layoutId: Int, val percentageWith: Float = 0f, val percentageHeight: Float = 0f) :
    RecyclerView.Adapter<GenericPhotoAdapter.GenericViewHolder<T>>(), Filterable {
            ...
            try {
                ...
                apply {
                    ...
                    if(widthPixel > 0 && heightPixel > 0){
                        ...
                        val screenSize = com.xcaret.xcaret_hotel.view.config.Utils.getScreenSize(itemView.context)
...
abstract class ListItemViewModel{
    ...
    @Ignore var onListItemViewClickListener: GenericPhotoAdapter.OnListItemViewClickListener? = null
}