package com.xcaret.xcaret_hotel.view.config.inputmask
...
import com.xcaret.xcaret_hotel.view.config.inputmask.helper.AffinityCalculationStrategy
import com.xcaret.xcaret_hotel.view.config.inputmask.helper.Mask
import com.xcaret.xcaret_hotel.view.config.inputmask.helper.RTLMask
import com.xcaret.xcaret_hotel.view.config.inputmask.model.CaretString
import com.xcaret.xcaret_hotel.view.config.inputmask.model.Notation
...
open class MaskedTextChangedListener(
    ...
    override fun afterTextChanged(edit: Editable?) {
        ...
        LogHX.d("mask", primaryFormat)
        LogHX.d("value", "${edit.toString()}, after: $afterText")
    ...
    override fun onFocusChange(view: View?, hasFocus: Boolean) {
        try {
            if (this.autocomplete && hasFocus) {
                ...
                val textAndCaret = CaretString(
                    text,
                    text.length,
                    CaretString.CaretGravity.FORWARD(this.autocomplete)
                )
