...
import com.xcaret.xcaret_hotel.databinding.EventListFragmentBinding
...
class EventListFragment: BaseFragmentDataBinding<WorkShopListViewModel, EventListFragmentBinding>() {
    override fun getLayout(): Int = R.layout.event_list_fragment
    ...
    private val workShopAdapter = GenericAdapter<Activity>(R.layout.item_event)
    ...
    private fun initComponents(){
        ...
        Utils.heighPercentage(binding.headerLayout, 0.40f)
    ...
    private fun setListeners(){
        ...
        workShopAdapter.setOnListItemViewClickListener(object: GenericAdapter.OnListItemViewClickListener{
            override fun onClick(view: View, position: Int) {
                ...
                navigate(R.id.action_eventListFragment_to_eventDetailFragment, args)
            }
        })
    }
}