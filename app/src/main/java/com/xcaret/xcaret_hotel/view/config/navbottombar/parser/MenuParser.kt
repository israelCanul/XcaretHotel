package com.xcaret.xcaret_hotel.view.config.navbottombar.parser
...
internal class MenuParser(private val context: Context) {
    ...
    private fun parseMenuItem(attrs: AttributeSet): MenuItem {
        ...
        val item = MenuItem(
            ...
            iconColor = sAttr.getColor(R.styleable.Bubble_android_iconTint, ContextCompat.getColor(context, R.color.color6))
        )
